...
// java KnapsackTest 10000000 50 8 100000 > KnapsackBenchmark/fractionalKnapsack_8threads.txt
// or
// java KnapsackTest 10000000 50 16 100000 > KnapsackBenchmark/fractionalKnapsack_16threads.txt
public class KnapsackTest {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i < NUM_TESTS; i++){
            ...
            //System.out.println("Test (Array) " + (i+1) + " (Single Thread)\tTime: " + singleThread / 1000000000.0 + "s | " + singleThread / 1.0 + "microsec");
            ...
            //System.out.println("Test (Array) " + (i+1) + " (Multi Thread)\tTime: " + multiThread / 1000000000.0 + "s | " + multiThread / 1.0 + "microsec");
            ...
            System.out.println("Test (ArrayList) " + (i+1) + " (Multi Thread)\tTime: " + multiThreadList / 1000000000.0 + "s | " + multiThreadList / 1.0 + "microsec");
        ...
        double multiThreadListAverageSeconds = multiThreadListAverage / 10000000000.0;
        ...
        System.out.println("Average Multi Thread Time (ArrayList): " + multiThreadListAverageSeconds + "s | " + multiThreadListAverage + "microsec");
