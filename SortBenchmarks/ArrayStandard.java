...
public class ArrayStandard 
{
    ...
    public static void main(String[] args) 
    {
        ...
        Integer[] items = new Integer[ARRAY_SIZE];
        for (int i = 0; i < ARRAY_SIZE; i++)
            items[i] = random.nextInt(1, ARRAY_SIZE);
        ...
        for (int i = 0; i < NUM_TESTS; i++)
        {
            ...
            // run single thread
            long[] singleThreadList = ArrayStandard.singleThreadMetric(items, ARRAY_SIZE);
            ...
            // run four thread
            long[] fourThreadList = ArrayStandard.nThreadMetric(items, 4);
            ...
            // run 8 thread
            long[] eightThreadList = ArrayStandard.nThreadMetric(items, 8);
            ...
            // run 16 thread
            long[] sixteenThreadList = ArrayStandard.nThreadMetric(items, 16);
    ...
    private static long[] singleThreadMetric(Integer [] items, int size)
    {
        long beforeUsedMem = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        long startTime = System.nanoTime();
        ArrayStandard.mergeSort(items);
        long endTime = System.nanoTime();
        long afterUsedMem = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        return new long[] {(endTime - startTime) / 1000, (afterUsedMem - beforeUsedMem) / 1000};
    }

    private static long[] nThreadMetric(Integer [] items, int threads)
    {
        long beforeUsedMem = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        long startTime = System.nanoTime();
